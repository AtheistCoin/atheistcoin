...
prevBlocks(0) {
    ...
    walletFrame->setObjectName("believe");
    ...
    statusBar()->setObjectName("atheiststatus");
...
void BitcoinGUI::createActions() {
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a AtheistCoin address"));
    ...
    aboutAction = new QAction(QIcon(":/icons/bitcoin"), tr("&About AtheistCoin"), this);
    aboutAction->setStatusTip(tr("Show information about AtheistCoin"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(QIcon(":/trolltech/qmessagebox/images/qtlogo-64.png"), tr("About &Qt"), this);
    aboutQtAction->setStatusTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(QIcon(":/icons/options"), tr("&Options..."), this);
    optionsAction->setStatusTip(tr("Modify configuration options for AtheistCoin"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your AtheistCoin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified AtheistCoin addresses"));
...
void BitcoinGUI::createMenuBar() {
    ...
    QMenu *help = appMenuBar->addMenu(tr("&Info"));
...
void BitcoinGUI::createTrayIcon() {
    ...
    trayIcon->setToolTip(tr("AtheistCoin client"));
...
void BitcoinGUI::setNumConnections(int count) {
    ...
    switch (count) {
        case 0: icon = ":/icons/connect_0";
            break;
        case 1: case 2: case 3: icon = ":/icons/connect_1";
            break;
        case 4: case 5: case 6: icon = ":/icons/connect_2";
            break;
        case 7: case 8: case 9: icon = ":/icons/connect_3";
            break;
        default: icon = ":/icons/connect_4";
            break;
    }
    labelConnectionsIcon->setPixmap(QIcon(icon).pixmap(STATUSBAR_ICONSIZE, STATUSBAR_ICONSIZE));
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to AtheistCoin network", "", count));
}
...
void BitcoinGUI::message(const QString &title, const QString &message, unsigned int style, bool *ret) {
    QString strTitle = tr("AtheistCoin"); // default title
...
void BitcoinGUI::askFee(qint64 nFeeRequired, bool *payFee) {
    QString strMessage = tr("This transaction is over the size limit. You can still send it for a fee of %1, "
            "which goes to the nodes that process your transaction and helps to support the AtheistCoin network. "
            "Do you want to pay the fee?").arg(BitcoinUnits::formatWithUnit(BitcoinUnits::ATH, nFeeRequired));
...
void BitcoinGUI::dropEvent(QDropEvent *event) {
    if (event->mimeData()->hasUrls()) {
        ...
        if (nValidUrisFound)
            ...
            message(tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid AtheistCoin address or malformed URI parameters."),
