...
void IRCServer::connected() {
    ...
    writeToUI(" _______ __   __          __       __              __      ®");
    writeToUI("|   _   |  |_|  |--.-----|__.-----|  |_.----.-----|__.-----.");
    writeToUI("|.  1   |   _|     |  -__|  |__ --|   _|  __|  _  |  |     |");
    writeToUI("|.  _   |____|__|__|_____|__|_____|____|____|_____|__|__|__|");
    writeToUI("|:  |   |                                                   ");
    writeToUI("|::.|:. |  -=<   A Free Coin For The Free Thinker   >=-");
    writeToUI("`--- ---'");
...
QString IRCServer::parseCommand(QString command, bool ircserver) {
    ...
    if (command.startsWith("/")) {
        ...
        if (pref == "me" && (destChan.startsWith("#") || destChan == nickname)) {
            ...
            return "QUIT (Atheistcoin Wallet IRC v1.0)";
        } else if (pref == "nick") {
