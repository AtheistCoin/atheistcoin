...
bool static ApplyProxySettings() {
    QSettings settings;
    CService addrProxy(settings.value("addrProxy", "127.0.0.1:950").toString().toStdString());
...
void OptionsModel::Init() {
    ...
    nDisplayUnit = settings.value("nDisplayUnit", BitcoinUnits::ATH).toInt();
    ...
    // These are shared with core AtheistCoin; we want
